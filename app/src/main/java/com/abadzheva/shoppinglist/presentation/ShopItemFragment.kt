...
class ShopItemFragment(
    ...
    companion object {
        ...
        fun newInstanceAddItem(): ShopItemFragment = ShopItemFragment(MODE_ADD)

        fun newInstanceEditItem(shopItemId: Int): ShopItemFragment = ShopItemFragment(MODE_EDIT, shopItemId)
